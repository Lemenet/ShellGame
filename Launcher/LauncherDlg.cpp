...
BEGIN_MESSAGE_MAP(CLauncherDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_Connect, &CLauncherDlg::OnBnClickedButtonConnect)
END_MESSAGE_MAP()
...
BOOL CLauncherDlg::OnInitDialog()
{
	...
	SetDlgItemText(IDC_EDIT_ID, _T("hhh"));
	SetDlgItemText(IDC_IPADDRESS_ServerIP, _T("127,0,0,1"));
	SetDlgItemText(IDC_EDIT_ServerPort, _T("2233"));
...
void CLauncherDlg::OnBnClickedButtonConnect()
{
	// TODO: 在此添加控件通知处理程序代码
